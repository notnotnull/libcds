...
adj_node_t *
create_node_w (size_t dst, size_t weight)
{
...
int
insert_wgraph_edge (wgraph_t *wg, size_t src, size_t dst, size_t weight)
{
  int ret_external = -1;
  if (wg == NULL)
    {
...
bool
find_wgraph_edge (wgraph_t *wg, size_t src, size_t dst)
{
...
int
remove_wgraph_edge (wgraph_t *wg, size_t src, size_t dst)
{
  int ret_external = -1;
  if (wg == NULL)
    {
...
adj_node_t *
find_wgraph_node (wgraph_t *wg, size_t src)
{
...
int
remove_wgraph_node (wgraph_t *wg, size_t src)
{
  int ret_external = -1;
  if (wg == NULL)
    {
...
size_t
calc_wgraph_weight (wgraph_t *wg, size_t *path, size_t path_len)
{
  size_t weight = 0;
  if (wg == NULL)
    {
...
static int
validate_graph_nodes (wgraph_t *wg, size_t src, size_t dst)
{
  int ret_val = -1;
  if (wg == NULL)
    {

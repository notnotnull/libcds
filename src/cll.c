...
void
cll_destroy (cll_t **cll, void (*destroy) (void *))
{
...
void
cll_empty (cll_t *cll, void (*destroy) (void *))
{
...
int
cll_insert_front (cll_t *cll, void *data)
{
  int ret_external = -1;
  int ret_internal;
  cll_node_t *new = NULL;
...
int
cll_insert_rear (cll_t *cll, void *data)
{
  int ret_external = -1;
  int ret_internal;
  cll_node_t *new = NULL;
...
int
cll_insert_at_pos (cll_t *cll, size_t index, void *data)
{
...
cll_node_t *
cll_search (cll_t *cll, void *data, int (*compare) (void *a, void *b))
{
...
int
cll_delete_node (cll_t *cll, void *data, void (*destroy) (void *))
{
  cll_node_t *current = NULL;
...
int
cll_sorted_insert (cll_t *cll, cll_node_t **head_ref, void *data, int (*compare) (void *a, void *b))
{
  int ret_val = -1;
  int compare_result;
...
static int
cll_insert_empty (cll_t *cll, void *data)
{
  int ret_val = -1;
